...
export default function Hero() {
  return (
    ...
    md:bg-black md:px-8 relative">
      ...
      <div className="max-w-7xl h-full md:grid md:grid-cols-7 flex justify-center overflow-hidden items-center">
        <div className="md:col-span-3 z-2 flex flex-col space-y-3 md:space-y-5 ">
          ...
          <h1 className="text-4xl md:text-5xl font-bold leading-snug ">
            Digital Solutions Made <br /> Simple & Affordable
          </h1>
          ...
          <button className="mt-6 w-[90%] md:max-w-70 md:mx-0 bg-orange-500 px-6 py-3 rounded-4xl text-lg cursor-pointer">
